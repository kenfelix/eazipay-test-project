...
from .otypes import Context, PydanticObjectIdType
...
schema = strawberry.federation.Schema(
    ...
    scalar_overrides={PydanticObjectId: PydanticObjectIdType},
)
...
app = FastAPI(
    ...
    desciption="setup for basic GraphQL backend service",
    port = 8000
    )
